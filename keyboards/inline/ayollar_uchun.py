...
ayollar_uchun = (InlineKeyboardMarkup( 
    inline_keyboard=[ 
        ...
        [ 
            InlineKeyboardButton(text="Pishiriqchilik 🎂", callback_data="pishiriq")
        ],
        [ 
            InlineKeyboardButton(text="Dizaynerlik 👗", callback_data="dizayner")
        ],
        [ 
            InlineKeyboardButton(text="Bichuvchilik 🧥", callback_data="bichish")
        ],
        [ 
            InlineKeyboardButton(text="To'quvchilik 🧶", callback_data="to'qish")
        ],
        [ 
            InlineKeyboardButton(text="Fan kurslari 📕", callback_data="fan")
        ],
        [ 
            InlineKeyboardButton(text="Tikuvchilik 🪡🧵", callback_data="tikuv")
        ],
        [ 
            InlineKeyboardButton(text="Salonchilik 💅🏻",callback_data="salon")
        ],
        [ 
            InlineKeyboardButton(text="Kashtachilik 🪢",callback_data="kashta")
        ],
        [ 
            InlineKeyboardButton(text="Orqaga ⬅️", callback_data="qaytishsh")
        ]
    ]
))
